...
public class AssetBundleBuilder : MonoBehaviour
{
	 ...
	 * ***********************************************************************/
	[MenuItem("Bundles/Build AssetBundles - PC")]
	static void BuildAllAssetBundlesPC()
	{
		 ...
		 * ***********************************************************************/
		BuildPipeline.BuildAssetBundles("Assets/AssetBundles/PC", BuildAssetBundleOptions.None, BuildTarget.StandaloneWindows);
	}
